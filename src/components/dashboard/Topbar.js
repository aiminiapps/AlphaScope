      ...
      <div className="flex items-center justify-between px-4 lg:px-6 py-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:flex items-center gap-2 px-3 py-2 rounded-xl bg-[#151515] border border-[#2A2A2A]">
            ...
            <span className="text-[#F5D90A] font-semibold text-sm">12,450</span>
          ...
          <button className="relative w-9 h-9 rounded-xl bg-[#151515] border border-[#2A2A2A] flex items-center justify-center text-[#888] hover:text-white transition-colors">
            ...
            <span className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-[#F5D90A] text-[#0B0B0B] text-[10px] font-bold flex items-center justify-center">
              3
            </span>
          </button>
                ...
                >
                  {connected ? (
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-[#F5D90A] text-[#0B0B0B] font-semibold text-sm hover:bg-[#F5D90A]/90 transition-colors"
                    >
                      Connect
                    </button>
                  )}
